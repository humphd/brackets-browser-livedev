...
(function(global) {
    ...
    function nativeXHRFn(condition, fn, args) {
        if(condition) {
    ...
    function XMLHttpRequestLiveDev() {
        ...
        var $abort = xhr.abort;
        xhr.abort = function() {
            if(!nativeXHRFn.call(xhr, !requestUrl, $abort, arguments)) {
                abortCalled = true;
            }
        };
        ...
        xhr.setRequestHeader = function() {
            nativeXHRFn.call(xhr, !requestUrl, $setRequestHeader, arguments);
        };

        var $getAllResponseHeaders = xhr.getAllResponseHeaders;
        xhr.getAllResponseHeaders = function() {
            return nativeXHRFn.call(xhr, !requestUrl, $getAllResponseHeaders, arguments);
        };

        var $getResponseHeader = xhr.getResponseHeader;
        xhr.getResponseHeader = function() {
            return nativeXHRFn.call(xhr, !requestUrl, $getResponseHeader, arguments);
        };

        var $overrideMimeType = xhr.overrideMimeType;
        xhr.overrideMimeType = function() {
            nativeXHRFn.call(xhr, !requestUrl, $overrideMimeType, arguments);
        };
