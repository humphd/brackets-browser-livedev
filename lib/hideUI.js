...
define(function (require, exports, module) {
	...
	function hide() {
    	...
    	//read URL params
    	params.parse();
    	console.log("This is params", params.parse());
    	/*
		if(shouldHideUI()) {
			removeMainToolBar();
	...
	/**
	 * This function parses the current url for brackets, and looks for Get Methods
	 */
	function shouldHideUI() {
		var sPageURL = window.location.search.substring(1);
	    var sParameterName = sPageURL.split('=');
	    if (sParameterName[0] == "ui") {
	    	if(sParameterName[1][0] === "1"){
	        	return false;
	    	}
	    }
	    return true;
